...
const MyChart = () => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(
                    ...
                    // `${MY_CHART_URL}/mychart/my_home?user_id=${id}${searchDate ? '&date=' + searchDate : ''}`
                );
    ...
    useEffect(() => {
        const fetchPred = async () => {
            try {
                const response = await axios.get(`http://192.168.0.84:5001/pred?user_id=${user['user_id']}`);

                // const response = await axios.get(`${MY_CHART_URL}/mychart/pred?user_id=${user['user_id']}`);
                const data = response.data;
                setUser({
                    ...user,
        ...
        if (user.user_id && period.length > 0) {
            fetchPred();
        }
    }, [user, period]);
                    ...
                    <div className={style.body}>
                        ...
                        <div className={style.container}>
                            ...
                            <div className={style.keyword_box} onClick={() => handleBoxClick(1)}>
                                <h1>
                                    {chartData1['my_total_usage'] ? chartData1['my_total_usage'] : 0}
                                    kw{' '}
                                </h1>
                                ...
                                <h1>
                                    {chartData1['my_total_usage']
                                        ? calculateBill(chartData1['my_total_usage']).toLocaleString('ko-KR')
                                        : 0}
                                    원
                                </h1>
                                <span>사용요금</span>
                                ...
                                <div className={style.chart_box}>
                                    ...
                                    <DoughnutChart
                                        data1={[
                                            ...
                                            Math.round(
                                                (chartData1['my_total_usage'] / chartData1['average_total_usage']) *
                                                    1000
                                            ) / 10,
                                        ]}
                                    />
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>요금</th>
                                                    <td>
                                                        {calculateBill(chartData1['my_total_usage']).toLocaleString(
                                                            'ko-KR'
                                                        )}{' '}
                                                        원
                                                    </td>
                                        ...
                                        {user['user_pred'] && (
                                            <>
                                                <p className={style.pred_text}>
                                                    ...
                                                    <span className={style.important_keywords}>
                                                        {user['user_pred']
                                                            ? calculateBill(user['user_pred']).toLocaleString('ko-KR')
                                                            : 0}
                                                        원
                                                    </span>
                                                    입니다.
                            ...
                            <div className={style.keyword_box} onClick={() => handleBoxClick(2)}>
                                <h1>{chartData2['user_type'] ? chartData2['user_type'] : '오전'} 소비 유형</h1>
                            ...
                            <div className={visibleContainers['2'] ? style.box_container : style.box_container_close}>
                                <div className={style.chart_box}>
                                    ...
                                    <PieChart
                                        chart_Data2={chartData2['usage_percentage'] && chartData2['usage_percentage']}
                                    />
                                    {/* 해설상자 */}
                                    <div className={style.text_box}>
                                        ...
                                        <p className={style.pred_text}>
                                            고객님의 시간별 전력 소비량을 합산한 결과, NOG가 평가한 고객님의 소비 유형은{' '}
                                            <span className={style.important_keywords}>
                            ...
                            <div className={style.keyword_box} onClick={() => handleBoxClick(3)}>
                                <h1>{chartData3['max_day'] ? chartData3['max_day'][0] : '월요일'}</h1>
                            ...
                            <div className={style.keyword_box} onClick={() => handleBoxClick(4)}>
                                <h1>
                                    {chartData3 && chartData3['max'] && chartData3['max'][0] ? chartData3['max'][0] : 1}
                                    일
                                </h1>
                            ...
                            <div className={visibleContainers['4'] ? style.box_container : style.box_container_close}>
                                <div className={style.chart_box}>
                                    ...
                                    <div className={style.text_box}>
                                        <p>
                                            회원님과 {user['user_city'] ? user['user_city'] : '같은 도시'}의 일일 전력
                                            사용량에 대한 비교 입니다.
                                        </p>
                            ...
                            <div className={visibleContainers['5'] ? style.box_container : style.box_container_close}>
                                <div className={style.chart_box}>
                                    ...
                                    <div className={style.text_box}>
                                        ...
                                        <p>
                                            회원님과 {user['user_city'] ? user['user_city'] : '같은 도시'}의 이번 달
                                            일일 평균 전력 사용량에 대한 비교 입니다.
                                        </p>
                                ...
                                <div className={style.chart_box}>
                                    ...
                                    <div className={style.text_box}>
                                        <p>
                                            ...
                                            {user['user_city'] ? user['user_city'] : '같은 도시'}의 지난 달 시간대 별
                                            평균 사용량과의 비교 입니다.
                                        </p>
                                        <table>
                                            <thead>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {chartData4 ? chartData4['city_average_daily_usage'] : 0} kWh
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>지난 달</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {' '}
                                                        {chartData4 ? chartData4['city_month_total_last_year'] : 0} kWh
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
