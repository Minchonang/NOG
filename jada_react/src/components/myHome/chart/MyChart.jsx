...
const MyChart = () => {
   ...
   useEffect(() => {
      const fetchPredData = async () => {
         ...
         try {
            // axios로 GET 요청 보내기
            const response = await axios.get(`http://192.168.0.84:5001/pred?user_id=${id}`);
            const data = response.data;
                              ...
                              <table className={style.custom_table}>
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>{chartData1['my_total_usage'] ? chartData1['my_total_usage'] : 0} kWh</td>
                              ...
                              <table className={style.custom_table}>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>{chartData4 ? chartData4['user_month_total_last_year'] : 0} kWh</td>
